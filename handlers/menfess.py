...
async def handle_document_menfess(message: types.Message):
    user_id = message.from_user.id
    caption = message.caption or ""
...
async def handle_voice_menfess(message: types.Message):
    user_id = message.from_user.id
    ...
    # Optional: kamu bisa pakai caption di voice kalau mau
...
async def handle_sticker_menfess(message: types.Message):
    user_id = message.from_user.id
