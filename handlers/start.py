...
def sub_keyboard() -> InlineKeyboardMarkup:
    kb = InlineKeyboardMarkup(inline_keyboard=[
        [InlineKeyboardButton("命 ｡ Subscribe Channel Base Menfess", url="https://t.me/sortfess")],
        [InlineKeyboardButton("命 ｡ Subscribe Channel Heart Heart", url="https://t.me/fiIIyourheart")],
